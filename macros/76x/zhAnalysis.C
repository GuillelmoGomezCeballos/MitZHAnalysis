...
void zhAnalysis(
 ...
 Int_t typeSel = 3
  ...
  TString filesPathDMMC  = "/scratch5/ceballos/ntuples_weightsDMMC_76x/";
  Double_t lumi = 2.318;
  TString processTag = "";
  ...
  // Data files
  infileName_.push_back(Form("%sdata_AOD_Run2015C_25ns.root",filesPathDA.Data()));											      infileCategory_.push_back(0);
  infileName_.push_back(Form("%sdata_AOD_Run2015D_25ns.root",filesPathDA.Data()));											      infileCategory_.push_back(0);
  
  // Monte carlo backgrounds
  infileName_.push_back(Form("%sWWTo2L2Nu_13TeV-powheg+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));                                            infileCategory_.push_back(1);
  infileName_.push_back(Form("%sGluGluWWTo2L2Nu_MCFM_13TeV+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v2+AODSIM.root",filesPathMC.Data()));					   infileCategory_.push_back(1);
  infileName_.push_back(Form("%sTTTo2L2Nu_13TeV-powheg+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));						   infileCategory_.push_back(1);
  infileName_.push_back(Form("%sST_tW_top_5f_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v2+AODSIM.root",filesPathMC.Data()));    infileCategory_.push_back(1);
  infileName_.push_back(Form("%sST_tW_antitop_5f_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));infileCategory_.push_back(1);

  infileName_.push_back(Form("%sWJetsToLNu_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));		   infileCategory_.push_back(1);
  infileName_.push_back(Form("%sWGToLNuG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));                  infileCategory_.push_back(1);
  infileName_.push_back(Form("%sGluGluHToWWTo2L2Nu_M125_13TeV_powheg_JHUgen_pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));		   infileCategory_.push_back(1);
  infileName_.push_back(Form("%sVBFHToWWTo2L2Nu_M125_13TeV_powheg_JHUgen_pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));                  infileCategory_.push_back(1);
  infileName_.push_back(Form("%sGluGluHToTauTau_M125_13TeV_powheg_pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));			   infileCategory_.push_back(1);
  infileName_.push_back(Form("%sVBFHToTauTau_M125_13TeV_powheg_pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));                            infileCategory_.push_back(1);
  //infileName_.push_back(Form("%sVHToNonbb_M125_13TeV_amcatnloFXFX_madspin_pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data())); 		   infileCategory_.push_back(1);
  //infileName_.push_back(Form("%sttHJetToNonbb_M125_13TeV_amcatnloFXFX_madspin_pythia8_mWCutfix+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));  infileCategory_.push_back(1);
  infileName_.push_back(Form("%sTTWJetsToLNu_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));	   infileCategory_.push_back(1);
  infileName_.push_back(Form("%sTTWJetsToQQ_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));	   infileCategory_.push_back(1);
  ...
  infileName_.push_back(Form("%sZGTo2LG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));                   infileCategory_.push_back(2);

  infileName_.push_back(Form("%sWZTo2L2Q_13TeV_amcatnloFXFX_madspin_pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));			   infileCategory_.push_back(3);
  infileName_.push_back(Form("%sWZTo3LNu_TuneCUETP8M1_13TeV-powheg-pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v2+AODSIM.root",filesPathMC.Data()));			   infileCategory_.push_back(3);

  infileName_.push_back(Form("%sZZTo2L2Nu_13TeV_powheg_pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));  				   infileCategory_.push_back(4);
  infileName_.push_back(Form("%sGluGluToContinToZZTo2mu2nu_13TeV_MCFM701_pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));		   infileCategory_.push_back(4);
  infileName_.push_back(Form("%sGluGluToContinToZZTo2e2nu_13TeV_MCFM701_pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));		   infileCategory_.push_back(4);
  infileName_.push_back(Form("%sZZTo2L2Q_13TeV_amcatnloFXFX_madspin_pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));			   infileCategory_.push_back(4);
  infileName_.push_back(Form("%sZZTo4L_13TeV_powheg_pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));					   infileCategory_.push_back(4);
  infileName_.push_back(Form("%sGluGluToContinToZZTo2e2mu_13TeV_MCFM701_pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));		   infileCategory_.push_back(4);
  infileName_.push_back(Form("%sGluGluToContinToZZTo2e2tau_13TeV_MCFM701_pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));		   infileCategory_.push_back(4);
  infileName_.push_back(Form("%sGluGluToContinToZZTo2mu2tau_13TeV_MCFM701_pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));	 	   infileCategory_.push_back(4);
  infileName_.push_back(Form("%sGluGluToContinToZZTo4e_13TeV_MCFM701_pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));		 	   infileCategory_.push_back(4);
  ...
  {  // Models 9 thru 15: ADD mono Z (7 models)
    ...
    signalName_.push_back("ADDMonoZ_ZToLL_MD-3_d-3"); infileName_.push_back(Form("%sADDMonoZ_ZToLL_MD-3_d-3_TuneCUETP8M1_13TeV-pythia8+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v2+AODSIM.root", filesPathDMMC.Data())); infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("ADDMonoZ_ZToLL_MD-3_d-4"); infileName_.push_back(Form("%sADDMonoZ_ZToLL_MD-3_d-4_TuneCUETP8M1_13TeV-pythia8+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data())); infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("ADDMonoZ_ZToLL_MD-3_d-5"); infileName_.push_back(Form("%sADDMonoZ_ZToLL_MD-3_d-5_TuneCUETP8M1_13TeV-pythia8+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data())); infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("ADDMonoZ_ZToLL_MD-3_d-6"); infileName_.push_back(Form("%sADDMonoZ_ZToLL_MD-3_d-6_TuneCUETP8M1_13TeV-pythia8+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data())); infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("ADDMonoZ_ZToLL_MD-3_d-7"); infileName_.push_back(Form("%sADDMonoZ_ZToLL_MD-3_d-7_TuneCUETP8M1_13TeV-pythia8+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data())); infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("ADDMonoZ_ZToLL_MD-3_d-8"); infileName_.push_back(Form("%sADDMonoZ_ZToLL_MD-3_d-8_TuneCUETP8M1_13TeV-pythia8+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v2+AODSIM.root", filesPathDMMC.Data())); infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
  } 
  { // Models 16 thru 99 : Axial  (83 models) (madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM)
    int i=signalName_.size(); 
    signalName_.push_back("AxialMonoZ_Mphi-10_Mchi-1_gSM-1p0_gDM-1p0");           infileName_.push_back(Form("%sAxialMonoZ_Mphi-10_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));                infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-10_Mchi-1_lep_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sAxialMonoZ_Mphi-10_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-10_Mchi-500_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sAxialMonoZ_Mphi-10_Mchi-500_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));              infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-10_Mchi-1000_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sAxialMonoZ_Mphi-10_Mchi-1000_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-20_Mchi-1_gSM-1p0_gDM-1p0");           infileName_.push_back(Form("%sAxialMonoZ_Mphi-20_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));                infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-50_Mchi-1_gSM-1p0_gDM-1p0");           infileName_.push_back(Form("%sAxialMonoZ_Mphi-50_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));                infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-50_Mchi-10_gSM-1p0_gDM-1p0");          infileName_.push_back(Form("%sAxialMonoZ_Mphi-50_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));               infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-50_Mchi-10_lep_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sAxialMonoZ_Mphi-50_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-50_Mchi-50_gSM-1p0_gDM-1p0");          infileName_.push_back(Form("%sAxialMonoZ_Mphi-50_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));               infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-50_Mchi-50_lep_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sAxialMonoZ_Mphi-50_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-95_Mchi-50_gSM-1p0_gDM-1p0");          infileName_.push_back(Form("%sAxialMonoZ_Mphi-95_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));               infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-95_Mchi-50_lep_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sAxialMonoZ_Mphi-95_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-100_Mchi-1_gSM-1p0_gDM-1p0");          infileName_.push_back(Form("%sAxialMonoZ_Mphi-100_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));               infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-100_Mchi-1_lep_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sAxialMonoZ_Mphi-100_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-100_Mchi-10_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sAxialMonoZ_Mphi-100_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));              infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-100_Mchi-10_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sAxialMonoZ_Mphi-100_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-100_Mchi-100_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sAxialMonoZ_Mphi-100_Mchi-100_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-100_Mchi-100_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sAxialMonoZ_Mphi-100_Mchi-100_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-195_Mchi-100_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sAxialMonoZ_Mphi-195_Mchi-100_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-195_Mchi-100_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sAxialMonoZ_Mphi-195_Mchi-100_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-200_Mchi-1_gSM-1p0_gDM-1p0");          infileName_.push_back(Form("%sAxialMonoZ_Mphi-200_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));               infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-200_Mchi-1_lep_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sAxialMonoZ_Mphi-200_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-200_Mchi-10_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sAxialMonoZ_Mphi-200_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));              infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-200_Mchi-10_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sAxialMonoZ_Mphi-200_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-200_Mchi-50_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sAxialMonoZ_Mphi-200_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));              infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-200_Mchi-50_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sAxialMonoZ_Mphi-200_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-200_Mchi-150_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sAxialMonoZ_Mphi-200_Mchi-150_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-200_Mchi-150_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sAxialMonoZ_Mphi-200_Mchi-150_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-295_Mchi-150_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sAxialMonoZ_Mphi-295_Mchi-150_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-300_Mchi-1_gSM-1p0_gDM-1p0");          infileName_.push_back(Form("%sAxialMonoZ_Mphi-300_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));               infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-300_Mchi-1_lep_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sAxialMonoZ_Mphi-300_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-300_Mchi-10_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sAxialMonoZ_Mphi-300_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));              infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-300_Mchi-10_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sAxialMonoZ_Mphi-300_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-300_Mchi-50_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sAxialMonoZ_Mphi-300_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));              infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-300_Mchi-50_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sAxialMonoZ_Mphi-300_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-300_Mchi-100_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sAxialMonoZ_Mphi-300_Mchi-100_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-500_Mchi-1_gSM-1p0_gDM-1p0");          infileName_.push_back(Form("%sAxialMonoZ_Mphi-500_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));               infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-500_Mchi-1_lep_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sAxialMonoZ_Mphi-500_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-500_Mchi-10_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sAxialMonoZ_Mphi-500_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));              infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-500_Mchi-10_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sAxialMonoZ_Mphi-500_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-500_Mchi-50_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sAxialMonoZ_Mphi-500_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));              infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-500_Mchi-100_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sAxialMonoZ_Mphi-500_Mchi-100_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-500_Mchi-100_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sAxialMonoZ_Mphi-500_Mchi-100_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-500_Mchi-150_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sAxialMonoZ_Mphi-500_Mchi-150_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-500_Mchi-150_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sAxialMonoZ_Mphi-500_Mchi-150_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-500_Mchi-500_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sAxialMonoZ_Mphi-500_Mchi-500_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-500_Mchi-500_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sAxialMonoZ_Mphi-500_Mchi-500_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-995_Mchi-500_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sAxialMonoZ_Mphi-995_Mchi-500_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-1000_Mchi-1_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sAxialMonoZ_Mphi-1000_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));              infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-1000_Mchi-1_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sAxialMonoZ_Mphi-1000_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-1000_Mchi-10_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sAxialMonoZ_Mphi-1000_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-1000_Mchi-10_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sAxialMonoZ_Mphi-1000_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-1000_Mchi-50_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sAxialMonoZ_Mphi-1000_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-1000_Mchi-50_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sAxialMonoZ_Mphi-1000_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-1000_Mchi-100_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sAxialMonoZ_Mphi-1000_Mchi-100_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-1000_Mchi-150_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sAxialMonoZ_Mphi-1000_Mchi-150_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-1000_Mchi-150_lep_gSM-1p0_gDM-1p0");   infileName_.push_back(Form("%sAxialMonoZ_Mphi-1000_Mchi-150_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-1000_Mchi-1000_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sAxialMonoZ_Mphi-1000_Mchi-1000_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-1000_Mchi-1000_lep_gSM-1p0_gDM-1p0");  infileName_.push_back(Form("%sAxialMonoZ_Mphi-1000_Mchi-1000_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-1995_Mchi-1000_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sAxialMonoZ_Mphi-1995_Mchi-1000_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-1995_Mchi-1000_lep_gSM-1p0_gDM-1p0");  infileName_.push_back(Form("%sAxialMonoZ_Mphi-1995_Mchi-1000_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-2000_Mchi-1_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sAxialMonoZ_Mphi-2000_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));              infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-2000_Mchi-10_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sAxialMonoZ_Mphi-2000_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-2000_Mchi-10_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sAxialMonoZ_Mphi-2000_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-2000_Mchi-50_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sAxialMonoZ_Mphi-2000_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-2000_Mchi-100_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sAxialMonoZ_Mphi-2000_Mchi-100_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-2000_Mchi-150_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sAxialMonoZ_Mphi-2000_Mchi-150_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-2000_Mchi-150_lep_gSM-1p0_gDM-1p0");   infileName_.push_back(Form("%sAxialMonoZ_Mphi-2000_Mchi-150_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-2000_Mchi-500_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sAxialMonoZ_Mphi-2000_Mchi-500_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-2000_Mchi-500_lep_gSM-1p0_gDM-1p0");   infileName_.push_back(Form("%sAxialMonoZ_Mphi-2000_Mchi-500_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-10000_Mchi-1_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sAxialMonoZ_Mphi-10000_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-10000_Mchi-1_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sAxialMonoZ_Mphi-10000_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-10000_Mchi-10_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sAxialMonoZ_Mphi-10000_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-10000_Mchi-10_lep_gSM-1p0_gDM-1p0");   infileName_.push_back(Form("%sAxialMonoZ_Mphi-10000_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-10000_Mchi-50_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sAxialMonoZ_Mphi-10000_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-10000_Mchi-50_lep_gSM-1p0_gDM-1p0");   infileName_.push_back(Form("%sAxialMonoZ_Mphi-10000_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-10000_Mchi-100_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sAxialMonoZ_Mphi-10000_Mchi-100_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-10000_Mchi-100_lep_gSM-1p0_gDM-1p0");  infileName_.push_back(Form("%sAxialMonoZ_Mphi-10000_Mchi-100_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-10000_Mchi-150_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sAxialMonoZ_Mphi-10000_Mchi-150_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-10000_Mchi-150_lep_gSM-1p0_gDM-1p0");  infileName_.push_back(Form("%sAxialMonoZ_Mphi-10000_Mchi-150_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("AxialMonoZ_Mphi-10000_Mchi-500_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sAxialMonoZ_Mphi-10000_Mchi-500_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
  ...
  { // dark matter models () (TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM)
    ...
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-1_Mv-100_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-1_Mv-100_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v2+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-1_Mv-200_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-1_Mv-200_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-1_Mv-300_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-1_Mv-300_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-1_Mv-500_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-1_Mv-500_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    ...
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-10_Mv-10_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-10_Mv-10_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-10_Mv-20_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-10_Mv-20_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    ...
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-10_Mv-100_gDMgQ-1");    infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-10_Mv-100_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-10_Mv-5000_gDMgQ-1");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-10_Mv-5000_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-50_Mv-10_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-50_Mv-10_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));                             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-50_Mv-50_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-50_Mv-50_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-50_Mv-95_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-50_Mv-95_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-50_Mv-200_gDMgQ-1");    infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-50_Mv-200_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v2+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-50_Mv-300_gDMgQ-1");    infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-50_Mv-300_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-150_Mv-10_gDMgQ-1");    infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-150_Mv-10_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    ...
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-150_Mv-500_gDMgQ-1");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-150_Mv-500_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-150_Mv-5000_gDMgQ-1");  infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-150_Mv-5000_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-500_Mv-10_gDMgQ-1");    infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-500_Mv-10_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-500_Mv-500_gDMgQ-1");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-500_Mv-500_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-500_Mv-995_gDMgQ-1");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-500_Mv-995_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    ...
    signalName_.push_back("DarkMatter_MonoZToLL_A_Mx-1000_Mv-10_gDMgQ-1");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_A_Mx-1000_Mv-10_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    ...
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-1_Mv-10_1-gDMgQ-1");    infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-1_Mv-10_1-gDMgQ_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-1_Mv-20_gDMgQ-1");      infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-1_Mv-20_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));                              infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-1_Mv-50_gDMgQ-1");      infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-1_Mv-50_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-1_Mv-100_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-1_Mv-100_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-1_Mv-200_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-1_Mv-200_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-1_Mv-300_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-1_Mv-300_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-1_Mv-500_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-1_Mv-500_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    ...
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-10_Mv-10_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-10_Mv-10_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-10_Mv-20_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-10_Mv-20_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-10_Mv-50_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-10_Mv-50_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));                             infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-10_Mv-100_gDMgQ-1");    infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-10_Mv-100_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-10_Mv-5000_gDMgQ-1");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-10_Mv-5000_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v2+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-50_Mv-10_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-50_Mv-10_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-50_Mv-50_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-50_Mv-50_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-50_Mv-95_gDMgQ-1");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-50_Mv-95_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v3+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-50_Mv-200_gDMgQ-1");    infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-50_Mv-200_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-50_Mv-300_gDMgQ-1");    infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-50_Mv-300_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-50_Mv-5000_gDMgQ-1");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-50_Mv-5000_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-150_Mv-10_gDMgQ-1");    infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-150_Mv-10_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-150_Mv-200_gDMgQ-1");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-150_Mv-200_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-150_Mv-295_gDMgQ-1");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-150_Mv-295_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));                           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-150_Mv-500_gDMgQ-1");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-150_Mv-500_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-150_Mv-5000_gDMgQ-1");  infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-150_Mv-5000_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));                          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-500_Mv-10_gDMgQ-1");    infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-500_Mv-10_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));                            infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-500_Mv-500_gDMgQ-1");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-500_Mv-500_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));                           infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-500_Mv-995_gDMgQ-1");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-500_Mv-995_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-500_Mv-2000_gDMgQ-1");  infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-500_Mv-2000_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-500_Mv-5000_gDMgQ-1");  infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-500_Mv-5000_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));                          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
    signalName_.push_back("DarkMatter_MonoZToLL_V_Mx-1000_Mv-10_gDMgQ-1");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_V_Mx-1000_Mv-10_gDMgQ-1_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++; 
  ...
  { // vector models
    ...
    signalName_.push_back("VectorMonoZ_Mphi-10_Mchi-50_gSM-1p0_gDM-1p0");          infileName_.push_back(Form("%sVectorMonoZ_Mphi-10_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10_Mchi-50_lep_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sVectorMonoZ_Mphi-10_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10_Mchi-100_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sVectorMonoZ_Mphi-10_Mchi-100_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10_Mchi-100_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sVectorMonoZ_Mphi-10_Mchi-100_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10_Mchi-500_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sVectorMonoZ_Mphi-10_Mchi-500_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10_Mchi-500_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sVectorMonoZ_Mphi-10_Mchi-500_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10_Mchi-1000_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-10_Mchi-1000_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-15_Mchi-10_gSM-1p0_gDM-1p0");          infileName_.push_back(Form("%sVectorMonoZ_Mphi-15_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-15_Mchi-10_lep_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sVectorMonoZ_Mphi-15_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-20_Mchi-1_gSM-1p0_gDM-1p0");           infileName_.push_back(Form("%sVectorMonoZ_Mphi-20_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));              infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-20_Mchi-1_lep_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sVectorMonoZ_Mphi-20_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-50_Mchi-1_gSM-1p0_gDM-1p0");           infileName_.push_back(Form("%sVectorMonoZ_Mphi-50_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));              infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-50_Mchi-1_lep_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sVectorMonoZ_Mphi-50_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-50_Mchi-10_gSM-1p0_gDM-1p0");          infileName_.push_back(Form("%sVectorMonoZ_Mphi-50_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-50_Mchi-10_lep_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sVectorMonoZ_Mphi-50_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-50_Mchi-50_lep_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sVectorMonoZ_Mphi-50_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-95_Mchi-50_gSM-1p0_gDM-1p0");          infileName_.push_back(Form("%sVectorMonoZ_Mphi-95_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-95_Mchi-50_lep_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sVectorMonoZ_Mphi-95_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-100_Mchi-1_gSM-1p0_gDM-1p0");          infileName_.push_back(Form("%sVectorMonoZ_Mphi-100_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-100_Mchi-1_lep_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sVectorMonoZ_Mphi-100_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-100_Mchi-10_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sVectorMonoZ_Mphi-100_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-100_Mchi-10_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sVectorMonoZ_Mphi-100_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-100_Mchi-100_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sVectorMonoZ_Mphi-100_Mchi-100_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-100_Mchi-100_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-100_Mchi-100_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-195_Mchi-100_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sVectorMonoZ_Mphi-195_Mchi-100_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-195_Mchi-100_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-195_Mchi-100_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-200_Mchi-1_gSM-1p0_gDM-1p0");          infileName_.push_back(Form("%sVectorMonoZ_Mphi-200_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-200_Mchi-1_lep_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sVectorMonoZ_Mphi-200_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-200_Mchi-10_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sVectorMonoZ_Mphi-200_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-200_Mchi-10_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sVectorMonoZ_Mphi-200_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-200_Mchi-50_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sVectorMonoZ_Mphi-200_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-200_Mchi-50_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sVectorMonoZ_Mphi-200_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-200_Mchi-150_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-200_Mchi-150_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-295_Mchi-150_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sVectorMonoZ_Mphi-295_Mchi-150_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-295_Mchi-150_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-295_Mchi-150_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-300_Mchi-1_gSM-1p0_gDM-1p0");          infileName_.push_back(Form("%sVectorMonoZ_Mphi-300_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));             infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-300_Mchi-1_lep_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sVectorMonoZ_Mphi-300_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-300_Mchi-10_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sVectorMonoZ_Mphi-300_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-300_Mchi-10_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sVectorMonoZ_Mphi-300_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-300_Mchi-50_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sVectorMonoZ_Mphi-300_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-300_Mchi-50_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sVectorMonoZ_Mphi-300_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-300_Mchi-100_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sVectorMonoZ_Mphi-300_Mchi-100_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    ...
    signalName_.push_back("VectorMonoZ_Mphi-500_Mchi-50_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sVectorMonoZ_Mphi-500_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-500_Mchi-100_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sVectorMonoZ_Mphi-500_Mchi-100_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-500_Mchi-100_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-500_Mchi-100_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-500_Mchi-150_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-500_Mchi-150_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-500_Mchi-500_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sVectorMonoZ_Mphi-500_Mchi-500_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-500_Mchi-500_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-500_Mchi-500_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-995_Mchi-500_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sVectorMonoZ_Mphi-995_Mchi-500_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-995_Mchi-500_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-995_Mchi-500_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-1000_Mchi-1_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sVectorMonoZ_Mphi-1000_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-1000_Mchi-10_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sVectorMonoZ_Mphi-1000_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-1000_Mchi-10_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-1000_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-1000_Mchi-50_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sVectorMonoZ_Mphi-1000_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-1000_Mchi-50_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-1000_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-1000_Mchi-100_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sVectorMonoZ_Mphi-1000_Mchi-100_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-1000_Mchi-100_lep_gSM-1p0_gDM-1p0");   infileName_.push_back(Form("%sVectorMonoZ_Mphi-1000_Mchi-100_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));      infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-1000_Mchi-150_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sVectorMonoZ_Mphi-1000_Mchi-150_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-1000_Mchi-1000_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sVectorMonoZ_Mphi-1000_Mchi-1000_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-1000_Mchi-1000_lep_gSM-1p0_gDM-1p0");  infileName_.push_back(Form("%sVectorMonoZ_Mphi-1000_Mchi-1000_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));     infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-1995_Mchi-1000_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sVectorMonoZ_Mphi-1995_Mchi-1000_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-1995_Mchi-1000_lep_gSM-1p0_gDM-1p0");  infileName_.push_back(Form("%sVectorMonoZ_Mphi-1995_Mchi-1000_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));     infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-2000_Mchi-1_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sVectorMonoZ_Mphi-2000_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-2000_Mchi-1_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sVectorMonoZ_Mphi-2000_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-2000_Mchi-10_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sVectorMonoZ_Mphi-2000_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-2000_Mchi-10_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-2000_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-2000_Mchi-50_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sVectorMonoZ_Mphi-2000_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-2000_Mchi-50_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-2000_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-2000_Mchi-100_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sVectorMonoZ_Mphi-2000_Mchi-100_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-2000_Mchi-100_lep_gSM-1p0_gDM-1p0");   infileName_.push_back(Form("%sVectorMonoZ_Mphi-2000_Mchi-100_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));      infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-2000_Mchi-150_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sVectorMonoZ_Mphi-2000_Mchi-150_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-2000_Mchi-150_lep_gSM-1p0_gDM-1p0");   infileName_.push_back(Form("%sVectorMonoZ_Mphi-2000_Mchi-150_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));      infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-2000_Mchi-500_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sVectorMonoZ_Mphi-2000_Mchi-500_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-2000_Mchi-500_lep_gSM-1p0_gDM-1p0");   infileName_.push_back(Form("%sVectorMonoZ_Mphi-2000_Mchi-500_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));      infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-5000_Mchi-1_gSM-1p0_gDM-1p0");         infileName_.push_back(Form("%sVectorMonoZ_Mphi-5000_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));            infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-5000_Mchi-1_lep_gSM-1p0_gDM-1p0");     infileName_.push_back(Form("%sVectorMonoZ_Mphi-5000_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));        infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-5000_Mchi-10_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sVectorMonoZ_Mphi-5000_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-5000_Mchi-10_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-5000_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-5000_Mchi-50_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sVectorMonoZ_Mphi-5000_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-5000_Mchi-50_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-5000_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-5000_Mchi-100_lep_gSM-1p0_gDM-1p0");   infileName_.push_back(Form("%sVectorMonoZ_Mphi-5000_Mchi-100_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));      infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-5000_Mchi-150_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sVectorMonoZ_Mphi-5000_Mchi-150_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-5000_Mchi-150_lep_gSM-1p0_gDM-1p0");   infileName_.push_back(Form("%sVectorMonoZ_Mphi-5000_Mchi-150_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));      infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-5000_Mchi-500_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sVectorMonoZ_Mphi-5000_Mchi-500_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-5000_Mchi-500_lep_gSM-1p0_gDM-1p0");   infileName_.push_back(Form("%sVectorMonoZ_Mphi-5000_Mchi-500_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));      infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-5000_Mchi-1000_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sVectorMonoZ_Mphi-5000_Mchi-1000_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-5000_Mchi-1000_lep_gSM-1p0_gDM-1p0");  infileName_.push_back(Form("%sVectorMonoZ_Mphi-5000_Mchi-1000_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));     infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10000_Mchi-1_gSM-1p0_gDM-1p0");        infileName_.push_back(Form("%sVectorMonoZ_Mphi-10000_Mchi-1_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));           infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10000_Mchi-1_lep_gSM-1p0_gDM-1p0");    infileName_.push_back(Form("%sVectorMonoZ_Mphi-10000_Mchi-1_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));       infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10000_Mchi-10_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sVectorMonoZ_Mphi-10000_Mchi-10_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10000_Mchi-10_lep_gSM-1p0_gDM-1p0");   infileName_.push_back(Form("%sVectorMonoZ_Mphi-10000_Mchi-10_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));      infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10000_Mchi-50_gSM-1p0_gDM-1p0");       infileName_.push_back(Form("%sVectorMonoZ_Mphi-10000_Mchi-50_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));          infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10000_Mchi-50_lep_gSM-1p0_gDM-1p0");   infileName_.push_back(Form("%sVectorMonoZ_Mphi-10000_Mchi-50_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));      infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10000_Mchi-100_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sVectorMonoZ_Mphi-10000_Mchi-100_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10000_Mchi-100_lep_gSM-1p0_gDM-1p0");  infileName_.push_back(Form("%sVectorMonoZ_Mphi-10000_Mchi-100_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));     infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10000_Mchi-150_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sVectorMonoZ_Mphi-10000_Mchi-150_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10000_Mchi-150_lep_gSM-1p0_gDM-1p0");  infileName_.push_back(Form("%sVectorMonoZ_Mphi-10000_Mchi-150_lep_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));     infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("VectorMonoZ_Mphi-10000_Mchi-500_gSM-1p0_gDM-1p0");      infileName_.push_back(Form("%sVectorMonoZ_Mphi-10000_Mchi-500_gSM-1p0_gDM-1p0_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root", filesPathDMMC.Data()));         infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
  ...
  { // EWK scalar models
    int i=signalName_.size();
    signalName_.push_back("DarkMatter_MonoZToLL_EWK_Scalar_Mx-1_Lambda-3000");     infileName_.push_back(Form("%sDarkMatter_MonoZToLL_EWK_Scalar_Mx-1_Lambda-3000_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",  filesPathDMMC.Data()));   infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("DarkMatter_MonoZToLL_EWK_Scalar_Mx-10_Lambda-3000");    infileName_.push_back(Form("%sDarkMatter_MonoZToLL_EWK_Scalar_Mx-10_Lambda-3000_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",  filesPathDMMC.Data()));  infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("DarkMatter_MonoZToLL_EWK_Scalar_Mx-50_Lambda-3000");    infileName_.push_back(Form("%sDarkMatter_MonoZToLL_EWK_Scalar_Mx-50_Lambda-3000_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",  filesPathDMMC.Data()));  infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("DarkMatter_MonoZToLL_EWK_Scalar_Mx-100_Lambda-3000");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_EWK_Scalar_Mx-100_Lambda-3000_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));  infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("DarkMatter_MonoZToLL_EWK_Scalar_Mx-200_Lambda-3000");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_EWK_Scalar_Mx-200_Lambda-3000_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));  infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("DarkMatter_MonoZToLL_EWK_Scalar_Mx-400_Lambda-3000");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_EWK_Scalar_Mx-400_Lambda-3000_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));  infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("DarkMatter_MonoZToLL_EWK_Scalar_Mx-800_Lambda-3000");   infileName_.push_back(Form("%sDarkMatter_MonoZToLL_EWK_Scalar_Mx-800_Lambda-3000_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root", filesPathDMMC.Data()));  infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
    signalName_.push_back("DarkMatter_MonoZToLL_EWK_Scalar_Mx-1300_Lambda-3000");  infileName_.push_back(Form("%sDarkMatter_MonoZToLL_EWK_Scalar_Mx-1300_Lambda-3000_TuneCUETP8M1_13TeV-madgraph+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathDMMC.Data()));  infileCategory_.push_back(6); signalIndex_.push_back(i); i++;
  }
  ...
  for(int nModel=0; nModel<nSigModels; nModel++) { 
    ...
    histo_ZH_hinv_CMS_MVAZHStatBoundingUp[nModel]	      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]  ->GetNbinsX(); i++) {if(histo_ZH_hinv[nModel]	->GetBinContent(i)>0)printf("%5.1f ",histo_ZH_hinv_CMS_MVAZHStatBoundingUp[nModel]	 ->GetBinContent(i)/histo_ZH_hinv[nModel]  ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZH_hinv_CMS_MVAZHStatBoundingDown[nModel]     ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]  ->GetNbinsX(); i++) {if(histo_ZH_hinv[nModel]	->GetBinContent(i)>0)printf("%5.1f ",histo_ZH_hinv_CMS_MVAZHStatBoundingDown[nModel]	 ->GetBinContent(i)/histo_ZH_hinv[nModel]  ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_VVV_CMS_MVAVVVStatBoundingUp	      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]  ->GetNbinsX(); i++) {if(histo_VVV	->GetBinContent(i)>0)printf("%5.1f ",histo_VVV_CMS_MVAVVVStatBoundingUp 	 ->GetBinContent(i)/histo_VVV	   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_VVV_CMS_MVAVVVStatBoundingDown        ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]  ->GetNbinsX(); i++) {if(histo_VVV	->GetBinContent(i)>0)printf("%5.1f ",histo_VVV_CMS_MVAVVVStatBoundingDown	 ->GetBinContent(i)/histo_VVV	   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_WZ_CMS_MVAWZStatBoundingUp	      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]  ->GetNbinsX(); i++) {if(histo_WZ	->GetBinContent(i)>0)printf("%5.1f ",histo_WZ_CMS_MVAWZStatBoundingUp		 ->GetBinContent(i)/histo_WZ       ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_WZ_CMS_MVAWZStatBoundingDown	      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]  ->GetNbinsX(); i++) {if(histo_WZ	->GetBinContent(i)>0)printf("%5.1f ",histo_WZ_CMS_MVAWZStatBoundingDown 	 ->GetBinContent(i)/histo_WZ	   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_MVAZZStatBoundingUp	      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]  ->GetNbinsX(); i++) {if(histo_ZZ	->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_MVAZZStatBoundingUp		 ->GetBinContent(i)/histo_ZZ       ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_MVAZZStatBoundingDown	      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]  ->GetNbinsX(); i++) {if(histo_ZZ	->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_MVAZZStatBoundingDown 	 ->GetBinContent(i)/histo_ZZ	   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_EM_CMS_MVAEMStatBoundingUp	      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]  ->GetNbinsX(); i++) {if(histo_EM	->GetBinContent(i)>0)printf("%5.1f ",histo_EM_CMS_MVAEMStatBoundingUp		 ->GetBinContent(i)/histo_EM       ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_EM_CMS_MVAEMStatBoundingDown	      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]  ->GetNbinsX(); i++) {if(histo_EM	->GetBinContent(i)>0)printf("%5.1f ",histo_EM_CMS_MVAEMStatBoundingDown 	 ->GetBinContent(i)/histo_EM	   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    ...
    histo_ZH_hinv_CMS_MVALepEffMBoundingUp[nModel]  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZH_hinv_CMS_MVALepEffMBoundingAvg[nModel]->GetBinContent(i)>0)printf("%5.1f ",histo_ZH_hinv_CMS_MVALepEffMBoundingUp[nModel]  ->GetBinContent(i)/histo_ZH_hinv_CMS_MVALepEffMBoundingAvg[nModel]->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZH_hinv_CMS_MVALepEffMBoundingDown[nModel]->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZH_hinv_CMS_MVALepEffMBoundingAvg[nModel]->GetBinContent(i)>0)printf("%5.1f ",histo_ZH_hinv_CMS_MVALepEffMBoundingDown[nModel]->GetBinContent(i)/histo_ZH_hinv_CMS_MVALepEffMBoundingAvg[nModel]->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_VVV_CMS_MVALepEffMBoundingUp	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_VVV_CMS_MVALepEffMBoundingAvg    ->GetBinContent(i)>0)printf("%5.1f ",histo_VVV_CMS_MVALepEffMBoundingUp      ->GetBinContent(i)/histo_VVV_CMS_MVALepEffMBoundingAvg    ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_VVV_CMS_MVALepEffMBoundingDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_VVV_CMS_MVALepEffMBoundingAvg    ->GetBinContent(i)>0)printf("%5.1f ",histo_VVV_CMS_MVALepEffMBoundingDown    ->GetBinContent(i)/histo_VVV_CMS_MVALepEffMBoundingAvg    ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_WZ_CMS_MVALepEffMBoundingUp	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_WZ_CMS_MVALepEffMBoundingAvg     ->GetBinContent(i)>0)printf("%5.1f ",histo_WZ_CMS_MVALepEffMBoundingUp       ->GetBinContent(i)/histo_WZ_CMS_MVALepEffMBoundingAvg     ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_WZ_CMS_MVALepEffMBoundingDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_WZ_CMS_MVALepEffMBoundingAvg     ->GetBinContent(i)>0)printf("%5.1f ",histo_WZ_CMS_MVALepEffMBoundingDown     ->GetBinContent(i)/histo_WZ_CMS_MVALepEffMBoundingAvg     ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_MVALepEffMBoundingUp	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZZ_CMS_MVALepEffMBoundingAvg     ->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_MVALepEffMBoundingUp       ->GetBinContent(i)/histo_ZZ_CMS_MVALepEffMBoundingAvg     ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_MVALepEffMBoundingDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZZ_CMS_MVALepEffMBoundingAvg     ->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_MVALepEffMBoundingDown     ->GetBinContent(i)/histo_ZZ_CMS_MVALepEffMBoundingAvg     ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    ...
    histo_ZH_hinv_CMS_MVALepEffEBoundingUp[nModel]  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZH_hinv_CMS_MVALepEffEBoundingAvg[nModel]->GetBinContent(i)>0)printf("%5.1f ",histo_ZH_hinv_CMS_MVALepEffEBoundingUp[nModel]  ->GetBinContent(i)/histo_ZH_hinv_CMS_MVALepEffEBoundingAvg[nModel]->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZH_hinv_CMS_MVALepEffEBoundingDown[nModel]->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZH_hinv_CMS_MVALepEffEBoundingAvg[nModel]->GetBinContent(i)>0)printf("%5.1f ",histo_ZH_hinv_CMS_MVALepEffEBoundingDown[nModel]->GetBinContent(i)/histo_ZH_hinv_CMS_MVALepEffEBoundingAvg[nModel]->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_VVV_CMS_MVALepEffEBoundingUp	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_VVV_CMS_MVALepEffEBoundingAvg    ->GetBinContent(i)>0)printf("%5.1f ",histo_VVV_CMS_MVALepEffEBoundingUp      ->GetBinContent(i)/histo_VVV_CMS_MVALepEffEBoundingAvg    ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_VVV_CMS_MVALepEffEBoundingDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_VVV_CMS_MVALepEffEBoundingAvg    ->GetBinContent(i)>0)printf("%5.1f ",histo_VVV_CMS_MVALepEffEBoundingDown    ->GetBinContent(i)/histo_VVV_CMS_MVALepEffEBoundingAvg    ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_WZ_CMS_MVALepEffEBoundingUp	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_WZ_CMS_MVALepEffEBoundingAvg     ->GetBinContent(i)>0)printf("%5.1f ",histo_WZ_CMS_MVALepEffEBoundingUp       ->GetBinContent(i)/histo_WZ_CMS_MVALepEffEBoundingAvg     ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_WZ_CMS_MVALepEffEBoundingDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_WZ_CMS_MVALepEffEBoundingAvg     ->GetBinContent(i)>0)printf("%5.1f ",histo_WZ_CMS_MVALepEffEBoundingDown     ->GetBinContent(i)/histo_WZ_CMS_MVALepEffEBoundingAvg     ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_MVALepEffEBoundingUp	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZZ_CMS_MVALepEffEBoundingAvg     ->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_MVALepEffEBoundingUp       ->GetBinContent(i)/histo_ZZ_CMS_MVALepEffEBoundingAvg     ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_MVALepEffEBoundingDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZZ_CMS_MVALepEffEBoundingAvg     ->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_MVALepEffEBoundingDown     ->GetBinContent(i)/histo_ZZ_CMS_MVALepEffEBoundingAvg     ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    ...
    histo_ZH_hinv_CMS_MVAMETBoundingUp[nModel]      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZH_hinv[nModel]        ->GetBinContent(i)>0)printf("%5.1f ",histo_ZH_hinv_CMS_MVAMETBoundingUp[nModel]      ->GetBinContent(i)/histo_ZH_hinv[nModel]      ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZH_hinv_CMS_MVAMETBoundingDown[nModel]    ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZH_hinv[nModel]        ->GetBinContent(i)>0)printf("%5.1f ",histo_ZH_hinv_CMS_MVAMETBoundingDown[nModel]   ->GetBinContent(i)/histo_ZH_hinv[nModel]   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_VVV_CMS_MVAMETBoundingUp	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_VVV  ->GetBinContent(i)>0)printf("%5.1f ",histo_VVV_CMS_MVAMETBoundingUp    ->GetBinContent(i)/histo_VVV  ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_VVV_CMS_MVAMETBoundingDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_VVV  ->GetBinContent(i)>0)printf("%5.1f ",histo_VVV_CMS_MVAMETBoundingDown  ->GetBinContent(i)/histo_VVV  ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_WZ_CMS_MVAMETBoundingUp	          ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_WZ    ->GetBinContent(i)>0)printf("%5.1f ",histo_WZ_CMS_MVAMETBoundingUp   ->GetBinContent(i)/histo_WZ   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_WZ_CMS_MVAMETBoundingDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_WZ    ->GetBinContent(i)>0)printf("%5.1f ",histo_WZ_CMS_MVAMETBoundingDown ->GetBinContent(i)/histo_WZ   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_MVAMETBoundingUp	          ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZZ    ->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_MVAMETBoundingUp   ->GetBinContent(i)/histo_ZZ   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_MVAMETBoundingDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZZ    ->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_MVAMETBoundingDown ->GetBinContent(i)/histo_ZZ   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    ...
    histo_ZH_hinv_CMS_MVAJESBoundingUp[nModel]	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZH_hinv[nModel]        ->GetBinContent(i)>0)printf("%5.1f ",histo_ZH_hinv_CMS_MVAJESBoundingUp[nModel]    ->GetBinContent(i)/histo_ZH_hinv[nModel]     ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZH_hinv_CMS_MVAJESBoundingDown[nModel]    ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZH_hinv[nModel]        ->GetBinContent(i)>0)printf("%5.1f ",histo_ZH_hinv_CMS_MVAJESBoundingDown[nModel]	 ->GetBinContent(i)/histo_ZH_hinv[nModel]      ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_VVV_CMS_MVAJESBoundingUp	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_VVV  ->GetBinContent(i)>0)printf("%5.1f ",histo_VVV_CMS_MVAJESBoundingUp      ->GetBinContent(i)/histo_VVV  ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_VVV_CMS_MVAJESBoundingDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_VVV  ->GetBinContent(i)>0)printf("%5.1f ",histo_VVV_CMS_MVAJESBoundingDown    ->GetBinContent(i)/histo_VVV  ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_WZ_CMS_MVAJESBoundingUp 	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_WZ    ->GetBinContent(i)>0)printf("%5.1f ",histo_WZ_CMS_MVAJESBoundingUp      ->GetBinContent(i)/histo_WZ   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_WZ_CMS_MVAJESBoundingDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_WZ    ->GetBinContent(i)>0)printf("%5.1f ",histo_WZ_CMS_MVAJESBoundingDown    ->GetBinContent(i)/histo_WZ   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_MVAJESBoundingUp 	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZZ    ->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_MVAJESBoundingUp      ->GetBinContent(i)/histo_ZZ   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_MVAJESBoundingDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZZ    ->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_MVAJESBoundingDown    ->GetBinContent(i)/histo_ZZ   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    ...
    histo_ZH_hinv_CMS_PUBoundingUp[nModel]      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZH_hinv[nModel]        ->GetBinContent(i)>0)printf("%5.1f ",histo_ZH_hinv_CMS_PUBoundingUp[nModel]      ->GetBinContent(i)/histo_ZH_hinv[nModel]      ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZH_hinv_CMS_PUBoundingDown[nModel]    ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZH_hinv[nModel]        ->GetBinContent(i)>0)printf("%5.1f ",histo_ZH_hinv_CMS_PUBoundingDown[nModel]   ->GetBinContent(i)/histo_ZH_hinv[nModel]   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_VVV_CMS_PUBoundingUp	      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_VVV  ->GetBinContent(i)>0)printf("%5.1f ",histo_VVV_CMS_PUBoundingUp    ->GetBinContent(i)/histo_VVV  ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_VVV_CMS_PUBoundingDown	      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_VVV  ->GetBinContent(i)>0)printf("%5.1f ",histo_VVV_CMS_PUBoundingDown  ->GetBinContent(i)/histo_VVV  ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_WZ_CMS_PUBoundingUp	      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_WZ    ->GetBinContent(i)>0)printf("%5.1f ",histo_WZ_CMS_PUBoundingUp   ->GetBinContent(i)/histo_WZ   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_WZ_CMS_PUBoundingDown	      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_WZ    ->GetBinContent(i)>0)printf("%5.1f ",histo_WZ_CMS_PUBoundingDown ->GetBinContent(i)/histo_WZ   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_PUBoundingUp	      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZZ    ->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_PUBoundingUp   ->GetBinContent(i)/histo_ZZ   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_PUBoundingDown	      ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZZ    ->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_PUBoundingDown ->GetBinContent(i)/histo_ZZ   ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    ...
    histo_WZ_CMS_EWKCorrUp	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_WZ->GetBinContent(i)>0)printf("%5.1f ",histo_WZ_CMS_EWKCorrUp  ->GetBinContent(i)/histo_WZ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_WZ_CMS_EWKCorrDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_WZ->GetBinContent(i)>0)printf("%5.1f ",histo_WZ_CMS_EWKCorrDown->GetBinContent(i)/histo_WZ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_EWKCorrUp	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZZ->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_EWKCorrUp  ->GetBinContent(i)/histo_ZZ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_EWKCorrDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZZ->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_EWKCorrDown->GetBinContent(i)/histo_ZZ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_ggCorrUp	          ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZZ->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_ggCorrUp  ->GetBinContent(i)/histo_ZZ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_ZZ_CMS_ggCorrDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_ZZ->GetBinContent(i)>0)printf("%5.1f ",histo_ZZ_CMS_ggCorrDown->GetBinContent(i)/histo_ZZ->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    printf("uncertainties Zjets\n");
    histo_Zjets_CMS_ZjetsSystUp	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_Zjets->GetBinContent(i)>0)printf("%5.1f ",histo_Zjets_CMS_ZjetsSystUp  ->GetBinContent(i)/histo_Zjets->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    histo_Zjets_CMS_ZjetsSystDown	  ->Write(); for(int i=1; i<=histo_ZH_hinv[nModel]->GetNbinsX(); i++) {if(histo_Zjets->GetBinContent(i)>0)printf("%5.1f ",histo_Zjets_CMS_ZjetsSystDown->GetBinContent(i)/histo_Zjets->GetBinContent(i)*100);else printf("100.0 ");} printf("\n");
    outFileLimits->Close();
