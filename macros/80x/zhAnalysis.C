...
void zhAnalysis(
 ...
 bool isMIT = true
  ...
  { // ls -l ~/eos/cms/store/caf/user/ceballos/Nero/output_80x/|grep -e DarkMatter -e Unpart -e ADD|awk '{printf("    signalName_.push_back(\"%s\"); infilenamev.push_back(Form(\"%s\", filesPathDMMC.Data())); infilecatv.push_back(6); signalIndex_.push_back(i); i++;\n",$9,$9)}'
    ...
    signalName_.push_back("DarkMatter_MonoZToLL_NLO_Vector_Mx2-50_Mv-500_gDM1_gQ0p25_TuneCUETP8M1_Mx1-1_ctau-10_13TeV-madgraph"); infilenamev.push_back(Form("%sDarkMatter_MonoZToLL_NLO_Vector_Mx2-50_Mv-500_gDM1_gQ0p25_TuneCUETP8M1_Mx1-1_ctau-10_13TeV-madgraph.root", filesPathDMMC.Data())); infilecatv.push_back(6); signalIndex_.push_back(i); i++;
  }
  ...
  if(makeMVAtrees) {
    ...
    data_mva_tree = new TTree("bkg_mva_tree_data", "MVA input tree with data events");
