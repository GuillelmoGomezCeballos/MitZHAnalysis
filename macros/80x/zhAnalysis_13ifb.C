...
bool isMINIAOD[3] = {false, false, true};
int whichSkim = 4;
...
void zhAnalysis_13ifb(
 ...
 bool verbose = false
  ...
  //infileName_.push_back(Form("%sWJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC.Data()));		  	       infileCategory_.push_back(1);
...
*/
  ...
  for(UInt_t ifile=0; ifile<infileName_.size(); ifile++) {
	...
	else if(MVAVarType == 3) MVAVar = TMath::Min((double)((TLorentzVector*)(*eventMet.p4)[0])->Pt(),xbins[nBinMVA]-0.001);
	else if(MVAVarType == 4) MVAVar = TMath::Min(ptFrac,xbins[nBinMVA]-0.001);
