...
root -q -l -b finalPlot2016.C+'(1,1,"BDT output","","inputs_zh_2016/histozz_postfit_nice.root","fullsel_bdt_zz_postfit",0,"ZH(125)",1,0,"ZZ region","","",1)';
root -q -l -b finalPlot2016.C+'(1,1,"BDT output","","inputs_zh_2016/histowz_postfit_nice.root","fullsel_bdt_wz_postfit",0,"ZH(125)",1,0,"WZ region","","",1)';
root -q -l -b finalPlot2016.C+'(2,1,"BDT output","","inputs_zh_2016/histozh_postfit_nice.root","fullsel_bdt_ll_postfit",0,"ZH(125)",1,0,"ee+#mu#mu","","",1)';
}
