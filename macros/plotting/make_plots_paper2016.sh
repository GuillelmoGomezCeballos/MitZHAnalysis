...
root -q -l -b finalPlot2016.C+'(1,1,"BDT classifier","","inputs_zh_2016/histo_1_bdt.root","fullsel_bdt_zz_postfit",0,"ZH(125)",1,0,"ZZ CR","","",1)';
root -q -l -b finalPlot2016.C+'(1,1,"BDT classifier","","inputs_zh_2016/histo_0_bdt.root","fullsel_bdt_wz_postfit",0,"ZH(125)",1,0,"WZ CR","","",1)';
root -q -l -b finalPlot2016.C+'(2,1,"BDT classifier","","inputs_zh_2016/histo_2_bdt.root","fullsel_bdt_ll_postfit",0,"ZH(125)",1,0,"ee+#mu#mu","","",1)';
